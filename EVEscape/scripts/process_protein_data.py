...
rbd_target_seq_path = 'H:/Py Files/coronavirus_final_revise/for_github_add_host/data/SARS-CoV-2 S test set.fasta'
...
spike_target_seq_path = 'H:/Py Files/coronavirus_final_revise/for_github_add_host/data/SARS-CoV-2 S test set.fasta'
...
spike.to_csv('../results/summaries/spike_scores_new.csv', index=False)
